...
PHP_BUILD_PATH="/usr/local/php"
PATH=/sbin:/usr/sbin:/bin:/usr/bin
DESC="PHP5 FastCGI Process Manager"
NAME=php-fpm
DAEMON=$PHP_BUILD_PATH/sbin/$NAME
DAEMON_ARGS="--fpm-config $PHP_BUILD_PATH/etc/php-fpm.conf"
PIDFILE=$PHP_BUILD_PATH/var/run/php-fpm.pid
TIMEOUT=30
